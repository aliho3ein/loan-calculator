    ...
    <section>
      ...
      {result > 0 && result < Infinity ? (
        <ul>
          <li>
            Monatliche Annuität :
            <span className="green"> {displayNumber(result.toFixed(2))}</span>
          </li>

          <li>
            Monatliche Tilgung :
            <span> {displayNumber((loan / (duration * 12)).toFixed(2))}</span>
          </li>
          ...
          <li>
            Gesamte Kosten :<span> {displayNumber(loan.toFixed(2))}</span>
          </li>
          <li>
            Gesamte Kauf Preis :
            <span> {displayNumber((result * 12 * duration).toFixed(2))}</span>
          </li>
        </ul>
      ) : (
